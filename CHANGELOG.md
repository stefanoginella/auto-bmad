...
- **A story run loads ~27% less reference text.** Every rule now has one home (SKILL.md is a
  thin entry point); the config commands (`config-commands.md`) and the opt-in external-CLI route
  (`cli-route.md`) are read only when used. Rules unchanged.
- **Only TEA delegates get the "answer menus with the default" clause.** build-auto is unattended
  by design and the retro is headless; every delegate still gets the git/foreground/needs-human tail.
- **PR bodies no longer carry the `🤖 Generated by auto-bmad` footer** (story and epic).
...
[Unreleased]: https://github.com/stefanoginella/auto-bmad/compare/v0.30.2...HEAD
[0.30.2]: https://github.com/stefanoginella/auto-bmad/compare/v0.30.1...v0.30.2
[0.30.1]: https://github.com/stefanoginella/auto-bmad/compare/v0.30.0...v0.30.1
[0.30.0]: https://github.com/stefanoginella/auto-bmad/compare/v0.29.0...v0.30.0
[0.29.0]: https://github.com/stefanoginella/auto-bmad/compare/v0.28.0...v0.29.0
