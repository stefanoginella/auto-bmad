...
> **Compatibility:** tested against the **[BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) 6.11 line** — floor **6.11.0**, tested up to **6.11.0** (and prerelease **6.11.1-next.21**) — and the separately versioned **[TEA test-architecture module](https://github.com/bmad-code-org/bmad-method-test-architecture-enterprise) v1 line** (the `testarch` skills) — floor **1.23.0**, tested up to **1.23.1** — auto-bmad couples to those skills' contracts rather than pinned versions.
