...
> **Compatibility:** tested against the **[BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) v6 skill line** up to **6.10.0** (and prerelease **6.10.1-next.49**), and the separately versioned **[TEA test-architecture module](https://github.com/bmad-code-org/bmad-method-test-architecture-enterprise) v1 line** (the `testarch` skills) up to **1.21.3** — auto-bmad couples to those skills' contracts rather than pinned versions.
