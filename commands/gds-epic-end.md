---
name: 'auto-gds-epic-end'
description: 'Close a GDS epic: retrospective, resolve retro actions, and project context refresh'
---
...
Close epic {{EPIC_ID}} with BMAD slash commands only — retrospective, retro action resolution, and project context refresh. Lightweight orchestration with git safety, no reports beyond the pipeline report.
...
```markdown
# Pipeline Report: gds-epic-end [Epic {{EPIC_ID}}]

| Field | Value |
|-------|-------|
| Pipeline | gds-epic-end |
| Epic | {{EPIC_ID}} |
| Start | {{START_TIME}} |
| End | {{END_TIME}} |
| Duration | <minutes>m |
...
|---|------|--------|----------|---------|
| 1 | Retrospective | done/failed | Xm | <top takeaway or improvement identified> |
| 2 | Project Context | done/failed | Xm | <refreshed with epic outcomes> |
...
- If all epics are done, the project is complete — consider a final end-to-end playtest and review
```
