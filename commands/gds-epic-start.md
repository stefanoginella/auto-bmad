---
name: 'auto-gds-epic-start'
description: 'Prepare and start a new GDS epic: epic-level game test design'
---
...
Prepare epic {{EPIC_ID}} with a single BMAD slash command — epic-level game test design. Lightweight orchestration with git safety.
...
```markdown
# Pipeline Report: gds-epic-start [Epic {{EPIC_ID}}]

| Field | Value |
|-------|-------|
| Pipeline | gds-epic-start |
| Epic | {{EPIC_ID}} |
| Start | {{START_TIME}} |
| End | {{END_TIME}} |
| Duration | <minutes>m |
...
|---|------|--------|----------|---------|
| 1 | Epic Test Design | done/failed | Xm | <game test areas planned, strategy summary> |
